/*
    ...
    #category: jQuery plugin - modaldialog
    #author: jericho(thisnamemeansnothing[at]gmail.com)
    #version: 0.1 alpha
    #date :2009-4-1 13:03:11
    #copyright (c) 2008 jericho(http://www.ajaxplaza.net/index.aspx)
    ========================================
    #example:
        $.fn.jmodal({
            title:'Information',
    ...
    #ps:
        ...
        in a *.css file and add <link /> in your pages 
*/
